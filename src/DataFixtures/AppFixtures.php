...
class AppFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $user2->setLastname('Bidochon');
        $user2->setFirstname('Albert');
        $user2->setPhone('0611111111');
        $user2->setAdress('Le Pastis');
        $user2->setCp('27300');
        ...
        $user3->setLastname('Lavinasse');
        $user3->setFirstname('Renaud');
        $user3->setPhone('0623456789');
        $user3->setAdress('Corbiere');
        $user3->setCp('76650');
        ...
        for ($i = 1; $i < 20; $i++) {
            ...
            $user->setLastname('Père'.$i);
            $user->setFirstname('Magloire'.$i);
            $user->setPhone('0623456789');
            $user->setAdress('Corbiere');
            $user->setCp('27820');
